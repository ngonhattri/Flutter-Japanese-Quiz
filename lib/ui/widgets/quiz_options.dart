...
import 'package:flutter_jpn_ocr/resources/api_provider.dart';
import 'package:flutter_jpn_ocr/ui/pages/error.dart';
import 'package:flutter_jpn_ocr/ui/pages/quiz_page.dart';
        ...
        child: Column(
          children: <Widget>[
            Container(
              ...
              child: Text(widget.category.name, style: Theme.of(context).textTheme.headline.copyWith(),),
            ),
